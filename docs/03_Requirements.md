...
| REQ-ID | Requirement Description                                              | Pri    |
| ------ | -------------------------------------------------------------------- | ------ |
| 010    | System must be easy to use without training                          | Must   |
| 011    | System must respond to user actions within 1 second                  | Must   |
| 012    | System must support at least 300 rooms                               | Must   |
| 013    | System must be secure                                                | Must   |
| 014    | System must be available 24/7 with minimal downtime                  | Must   |
| 015    | System must support integration with existing hotel lighting systems | Must   |
| 016    | System must comply with EU safety and data protection regulations    | Must   |
| 017    | System should support mobile and desktop access                      | Should |
| 018    | System should allow remote management over internet                  | Should |
| 019    | System could provide analytics on energy usage and lighting patterns | Could  |
